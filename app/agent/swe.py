...
def check_tools(self) -> "SWEAgent":
        ...
        if not {"bash", "str_replace_editor", "terminate"}.issubset(self.available_tools.tool_map.keys()):
            raise ValueError("SWEAgent requires 'bash', 'str_replace_editor', and 'terminate' tools.")
        return self
